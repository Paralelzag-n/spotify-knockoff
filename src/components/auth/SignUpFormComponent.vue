...
const repeatPasswordVisible = ref<boolean>(false);
...
const computedRepeatPasswordVisibilityIcon = computed(() => {
  return {
    "fa-eye": !repeatPasswordVisible.value,
    "fa-eye-slash": repeatPasswordVisible.value,
  };
});
...
<template>
  ...
  >
    <h2 class="text-4xl font-bold text-center pb-10">Sign up to Paralelify</h2>
    ...
    <div class="flex flex-col gap-4 w-full">
      <BaseInput
        ...
        label="Email"
        placeholder="devs@paralelify.com"
      />
      <BaseInput
        v-model="password"
      ...
      <BaseInput
        ...
        :password="repeatPasswordVisible"
        :rules="[requiredRule, lengthRule(8)]"
      ...
      >
        <template #append>
          ...
          >
            <i
              :class="computedRepeatPasswordVisibilityIcon"
              class="fa-solid text-sm"
            />
          </BaseButton>
        </template>
